...
for %%I in %libs% do (
  ...
  rem set symbols=NetOfficeFw.!library!.!_version!!_suffix!.symbols.nupkg
  set symbols=NetOfficeFw.!library!.!_version!!_suffix!.snupkg
  ...
  nuget.exe push out\signed\!symbols! "!_token!" -NonInteractive -ForceEnglishOutput -Source https://api.nuget.org/v3/index.json
  if ERRORLEVEL 1 (
